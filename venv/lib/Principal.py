...
def draw(G, pos, custom_node_labels, pos_text_coordinates, measures, measure_name):
    ...
    plt.colorbar(nodes)
    plt.axis('off')
    plt.savefig("/home/akina/Dropbox/TCC/Exemplos/"+ measure_name + ".png")
    plt.show()

###########################################################################

G = nx.krackhardt_kite_graph()
pos = {3:(3,3),5:(6,4),2:(3,5),0:(0,4),6:(6,2),4:(3,1),1:(0,2),7:(9,3),8:(12,3),9:(15,3)}
...
custom_node_labels={}
for v in G.nodes():
    custom_node_labels[v]=round(degree_centrality[v], 2)

draw(G, pos, custom_node_labels, pos_text_coordinates, degree_centrality, 'Centralidade de Grau')
...
draw(G, pos, custom_node_labels, pos_text_coordinates, eigenvector_centrality, 'Centralidade de Autovetor')
...
custom_node_labels={}
for v in G.nodes():
    custom_node_labels[v]=round(closeness_centrality[v], 2)

draw(G, pos, custom_node_labels, pos_text_coordinates, closeness_centrality, 'Centralidade de Proximidade')
...
custom_node_labels={}
for v in G.nodes():
    custom_node_labels[v]=round(betweenness_centrality[v], 2)

draw(G, pos, custom_node_labels, pos_text_coordinates, betweenness_centrality, 'Centralidade de Intermediação')
